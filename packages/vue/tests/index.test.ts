...
import { createMpesaClient, MpesaVueClient } from "../src/index";
...
describe("Package Exports", () => {
  ...
  it("should export MpesaVueClient class", () => {
    expect(MpesaVueClient).toBeDefined();
    expect(typeof MpesaVueClient).toBe("function");
  });

  it("should create instance using createMpesaClient", () => {
    const client = createMpesaClient();
    expect(client).toBeInstanceOf(MpesaVueClient);
  });

  it("should create instance of MpesaVueClient directly", () => {
    const client = new MpesaVueClient();
    expect(client).toBeInstanceOf(MpesaVueClient);
  });
