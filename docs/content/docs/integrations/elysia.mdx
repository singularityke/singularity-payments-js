---
title: Elysia
description: Singularity payments can be integrated into your Elysia application with ease.
---
...
<Tabs items={["npm", "pnpm", "yarn", "bun"]}>
  <Tab value="npm">
```bash
npm install @singularity-payments/elysia dotenv
```

  </Tab>
  <Tab value="pnpm">
```bash
pnpm add @singularity-payments/elysia dotenv
```

  </Tab>
  <Tab value="yarn">
```bash
yarn add @singularity-payments/elysia dotenv
```

  </Tab>
  <Tab value="bun">
```bash
bun add @singularity-payments/elysia dotenv
```
