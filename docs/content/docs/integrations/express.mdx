---
title: Express
description: Singularity payments can be integrated into your Express application with ease.
---
...
<Tabs items={["npm", "pnpm", "yarn", "bun"]}>
  <Tab value="npm">
```bash
npm install @singularity-payments/express dotenv
```

  </Tab>
  <Tab value="pnpm">
```bash
pnpm add @singularity-payments/express dotenv
```

  </Tab>
  <Tab value="yarn">
```bash
yarn add @singularity-payments/express dotenv
```

  </Tab>
  <Tab value="bun">
```bash
bun add @singularity-payments/express dotenv
```
